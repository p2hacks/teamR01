...
import(
	...
	"github.com/p2hacks/teamR01/server/pair/config"
	"github.com/p2hacks/teamR01/server/pair/controller"
...
func setupRouter(ctrl controller.IsController) *gin.Engine {
	...
	router.GET("/", func(c *gin.Context){
		c.JSON(http.StatusOK, gin.H{"message": "This is Pair API"})
	})
	router.POST("/set", ctrl.GetPairInfo)
	return router
}